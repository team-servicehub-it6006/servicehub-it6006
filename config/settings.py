...
if not DEBUG:
    ...
    # Set this only behind a proxy that strips untrusted forwarded-proto headers.
    if env_flag('DJANGO_TRUST_PROXY'):
...
if DEBUG:
    ...
    EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'no-reply@servicehub.local')
